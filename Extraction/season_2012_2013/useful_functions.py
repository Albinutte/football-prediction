...
def get_soup(url="http://www.championat.com/football/_england/548/result.html"):
    """Gets soup from url"""
...
def get_statto_soup(driver, date, url="http://www.statto.com/football/stats/england/premier-league/2012-2013/table"):
